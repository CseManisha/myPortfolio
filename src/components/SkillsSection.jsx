  ...
  return(
    ...
    >
         <div className="container mx-auto max-w-5xl"> 
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
                  {categories.map((category,key) => (
                    ...
                    onClick={() => setActiveCategory(category)}
                     className={cn(
                      "px-5 py-2 rounded-full transition-colors duratio-300 capitalize",
          ...
          <div className="grid grid-cols-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredSkills.map((skill,key) => (
                ...
                >
                  ...
                  <div className="w-full bg-secondary/50 rounded-full overflow-hidden">
                      <div className="bg-primary h-2 rounded-full origin-left animate-lgrow_1.5s_ease-out"
